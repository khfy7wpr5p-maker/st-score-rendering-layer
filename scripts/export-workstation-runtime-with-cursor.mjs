...
export function isRealmSafePlainInteractionObject(payload) {
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  console.log(`Workstation runtime exported with cursor and generic rendered-event interaction bridge: ${path.relative(repoRoot, result.destinationRoot)}`);
